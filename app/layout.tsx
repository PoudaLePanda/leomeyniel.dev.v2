...
export const metadata: Metadata = {
  ...
  description: 'Portfolio de Léo Meyniel, développeur full stack spécialisé en React, Next.js, Node.js et TypeScript. Découvrez mes projets et compétences techniques.',
  keywords: ['Léo Meyniel', 'développeur full stack', 'React', 'Next.js', 'TypeScript', 'Node.js', 'portfolio', 'développeur web'],
